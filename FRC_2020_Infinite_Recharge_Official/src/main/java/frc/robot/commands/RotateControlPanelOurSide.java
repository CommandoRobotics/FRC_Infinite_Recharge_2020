...
public class RotateControlPanelOurSide extends CommandBase {
  ...
  public RotateControlPanelOurSide(char targetColor, ColorWheelSubsystem sub) {
  ...
  public void initialize() {
    ...
    colorWheelSubsystem.setSetpoint(controlPanelAPI.calculateOurSide(targetColor));
  }
